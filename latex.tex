...
\begin{center}
    ...
    \begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
        ...
        %Shape: Polygon [id:ds62210461052461] 
        \draw  [draw opacity=0][fill={rgb, 255:red, 155; green, 155; blue, 155 }  ,fill opacity=1 ] (446,61.5) -- (459.5,158.5) -- (362,104.5) -- cycle ;
        %Straight Lines [id:da6323615479571254] 
        \draw    (146.5,105) -- (230.5,62) ;
        \draw [shift={(230.5,62)}, rotate = 332.89] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
        \draw [shift={(146.5,105)}, rotate = 332.89] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
        %Straight Lines [id:da22947751291283436] 
        \draw    (244,159) -- (146.5,105) ;
        \draw [shift={(146.5,105)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
        \draw [shift={(244,159)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
        %Straight Lines [id:da019993107580255298] 
        \draw    (230.5,62) -- (244,159) ;
        \draw [shift={(244,159)}, rotate = 82.08] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
        \draw [shift={(230.5,62)}, rotate = 82.08] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
        %Straight Lines [id:da9602231519134856] 
        \draw    (146.5,105) -- (193.5,131.03) ;
        \draw [shift={(195.25,132)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
        %Straight Lines [id:da06336239210143191] 
        \draw    (244,159) -- (237.53,112.48) ;
        \draw [shift={(237.25,110.5)}, rotate = 82.08] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
        %Straight Lines [id:da9342184983311856] 
        \draw    (146.5,105) -- (186.72,84.41) ;
        \draw [shift={(188.5,83.5)}, rotate = 152.89] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
        %Straight Lines [id:da8534575157718434] 
        \draw    (362,104.5) -- (446,61.5) ;
        \draw [shift={(446,61.5)}, rotate = 332.89] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
        \draw [shift={(362,104.5)}, rotate = 332.89] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
        %Straight Lines [id:da1637095784343361] 
        \draw    (459.5,158.5) -- (362,104.5) ;
        \draw [shift={(362,104.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
        \draw [shift={(459.5,158.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
        %Straight Lines [id:da030526274938948328] 
        \draw    (446,61.5) -- (459.5,158.5) ;
        \draw [shift={(459.5,158.5)}, rotate = 82.08] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
        \draw [shift={(446,61.5)}, rotate = 82.08] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
        %Straight Lines [id:da8363020383689839] 
        \draw    (362,104.5) -- (409,130.53) ;
        \draw [shift={(410.75,131.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
        %Straight Lines [id:da3121820232703665] 
        \draw    (459.5,158.5) -- (453.03,111.98) ;
        \draw [shift={(452.75,110)}, rotate = 82.08] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
        %Straight Lines [id:da17306729671444487] 
        \draw    (362,104.5) -- (402.22,83.91) ;
        \draw [shift={(404,83)}, rotate = 152.89] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
        %Shape: Boxed Bezier Curve [id:dp5745803473335898] 
        \draw    (434.07,96.37) .. controls (397.11,76.86) and (416,141.14) .. (435.19,107.81) ;
        \draw [shift={(436.07,106.22)}, rotate = 117.83] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;

        % Text Node
        \draw (119.5,96.9) node [anchor=north west][inner sep=0.75pt]    {$P_{0}$};
        % Text Node
        \draw (246,162.4) node [anchor=north west][inner sep=0.75pt]    {$P_{1}$};
        % Text Node
        \draw (232.5,41.4) node [anchor=north west][inner sep=0.75pt]    {$P_{2}$};
        % Text Node
        \draw (335,96.4) node [anchor=north west][inner sep=0.75pt]    {$P_{0}$};
        % Text Node
        \draw (461.5,161.9) node [anchor=north west][inner sep=0.75pt]    {$P_{1}$};
        % Text Node
        \draw (448,40.9) node [anchor=north west][inner sep=0.75pt]    {$P_{2}$};
        % Text Node
        \draw (140,14.9) node [anchor=north west][inner sep=0.75pt]    {$K$};
        % Text Node
        \draw (356,15.9) node [anchor=north west][inner sep=0.75pt]    {$L$};


    \end{tikzpicture}

\end{center}
Prendiamo come mappa simpliciale mla mappa identità $i:K\ra L$
\[
    P_i\longmapsto P_i
\]
I gruppi di omologia sono immediati dalla natura geometrica
\[
    H_p(K)=\begin{cases}
        \Z\simeq\gen{P_0}                           & p=0       \\
        \Z\simeq\gen{[P_0,P_1]+[P_1,P_2]-[P_0,P_2]} & p=1       \\
        \{0\}                                       & p\neq 0,1
    \end{cases}
\]
\[
...
\end{center}
con $f:K\ra L$ definita da
\[
    P_0\longmapsto P_0\quad P_1\longmapsto P_1
\]
\[
    P_2\longmapsto P_1
\]
\[
    (f_\#)_0:C_0(K)=\gen{P_0,P_1,P_2}\ra C_0(L)=\gen{P_0,P_1,P_2}
\]
\[
    (f_\#)_0=\begin{blockarray}{rrrl}
        P_0 & P_1 & P_2 & \\
        \begin{block}{[rrr]l}
            1 & 0 & 0\topstrut & P_0\\
            0 & 1 & 1 & P_1\\
...
%Shape: Polygon [id:ds5342942412692322] 
\draw  [draw opacity=0][fill={rgb, 255:red, 155; green, 155; blue, 155 }  ,fill opacity=1 ] (561,61.5) -- (574.5,158.5) -- (459.5,158.5) -- (362,104.5) -- (446,61.5) -- cycle ;
%Straight Lines [id:da6323615479571254] 
\draw    (146.5,105) -- (230.5,62) ;
\draw [shift={(230.5,62)}, rotate = 332.89] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(146.5,105)}, rotate = 332.89] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
...
\draw    (362,104.5) -- (402.22,83.91) ;
\draw [shift={(404,83)}, rotate = 152.89] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da4245704012947664] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (477,104.5) -- (561,61.5) ;
\draw [shift={(561,61.5)}, rotate = 332.89] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(477,104.5)}, rotate = 332.89] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da33823835536111346] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (574.5,158.5) -- (477,104.5) ;
\draw [shift={(477,104.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(574.5,158.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da9133491311064148] 
\draw    (561,61.5) -- (574.5,158.5) ;
\draw [shift={(574.5,158.5)}, rotate = 82.08] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(561,61.5)}, rotate = 82.08] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da21948260416623633] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (477,104.5) -- (524,130.53) ;
\draw [shift={(525.75,131.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da36324912920225416] 
\draw    (574.5,158.5) -- (568.03,111.98) ;
\draw [shift={(567.75,110)}, rotate = 82.08] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da37640631411703684] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (477,104.5) -- (517.22,83.91) ;
\draw [shift={(519,83)}, rotate = 152.89] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da532793372684391] 
\draw    (446,61.5) -- (561,61.5) ;
%Straight Lines [id:da4008252813501427] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (362,104.5) -- (477,104.5) ;
%Straight Lines [id:da2888913533115496] 
\draw    (459.5,158.5) -- (574.5,158.5) ;
%Straight Lines [id:da28460565203588817] 
\draw    (459.5,158.5) -- (515,158.5) ;
\draw [shift={(517,158.5)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da6289494818065484] 
\draw    (446,61.5) -- (501.5,61.5) ;
\draw [shift={(503.5,61.5)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da4846791714374943] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (362,104.5) -- (417.5,104.5) ;
\draw [shift={(419.5,104.5)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da6964303388545676] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (362,104.5) -- (574.5,158.5) ;
%Straight Lines [id:da6139520980020683] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (446,61.5) -- (477,104.5) ;
%Straight Lines [id:da5548093922178561] 
\draw    (561,61.5) -- (459.5,158.5) ;
%Straight Lines [id:da5077451624405167] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (362,104.5) -- (466.31,131.01) ;
\draw [shift={(468.25,131.5)}, rotate = 194.26] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da40680782829094997] 
\draw    (459.5,158.5) -- (508.8,111.38) ;
\draw [shift={(510.25,110)}, rotate = 136.3] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da05798363751624147] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (446,61.5) -- (460.33,81.38) ;
\draw [shift={(461.5,83)}, rotate = 234.21] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
...
\draw (232.5,41.4) node [anchor=north west][inner sep=0.75pt]    {$P_{2}$};
% Text Node
\draw (55.5,18.4) node [anchor=north west][inner sep=0.75pt]    {$K=\{[ P_{0} ,P_{1}] ,[ P_{1} ,P_{2}] ,[ P_{1} ,P_{2}] ,P_{0} ,P_{1} ,P_{2}\}$};
% Text Node
\draw (238,206.9) node [anchor=north west][inner sep=0.75pt]    {$ \begin{array}{l}
L=\{[ Q_{0} ,Q_{1} ,Q_{4}] ,[ Q_{0} ,Q_{2} ,Q_{3}] ,[ Q_{0} ,Q_{3} ,Q_{4}] ,\\
\quad \quad \quad [ Q_{1} ,Q_{2} ,Q_{5}] ,[ Q_{1} ,Q_{4} ,Q_{5}] ,[ Q_{2} ,Q_{3} ,Q_{5}]\} \cup \left\{\text{facce}\right\}
\end{array}$};
% Text Node
\draw (334.5,94.4) node [anchor=north west][inner sep=0.75pt]    {$Q_{0}$};
% Text Node
\draw (449,168.9) node [anchor=north west][inner sep=0.75pt]    {$Q_{1}$};
% Text Node
\draw (434,35.9) node [anchor=north west][inner sep=0.75pt]    {$Q_{2}$};
% Text Node
\draw (472,76.4) node [anchor=north west][inner sep=0.75pt]    {$Q_{3}$};
% Text Node
\draw (579.5,165.9) node [anchor=north west][inner sep=0.75pt]    {$Q_{4}$};
% Text Node
\draw (561.5,38.9) node [anchor=north west][inner sep=0.75pt]    {$Q_{5}$};


\end{tikzpicture}

\end{center}
e prendiamo le due mappe simpliciali
\[
    f:K\ra L\quad P_0\mapsto Q_0\quad P_1\mapsto Q_1\quad P_2\mapsto Q_2
\]
\[
    g:K\ra L\quad P_0\mapsto Q_3\quad P_1\mapsto Q_4\quad P_2\mapsto Q_5    
\]
\paragraph{$\mathbf{H_0}$} $f$ e $g$ inducono lo stesso omomorfismo tra i gruppi $H_0(K)$ e $H_0(L)$ se
\[
    \begin{cases}
        \exists d_0\in C_1(L)\quad t.c.\quad (f_\#)_0(P_0)-(g_\#)_0(P_0)=\partial_1 d_0\\
        \exists d_1\in C_1(L)\quad t.c.\quad (f_\#)_0(P_1)-(g_\#)_0(P_1)=\partial_1 d_1\\
        \exists d_2\in C_1(L)\quad t.c.\quad (f_\#)_0(P_2)-(g_\#)_0(P_2)=\partial_1 d_2\\
    \end{cases}
\]
dai calcoli risulta
\[
    (f_\#)_0(P_0)-(g_\#)_0(P_0)=Q_0-Q_3=\partial_1[Q_3,Q_0]
\]
\[
    (f_\#)_0(P_1)-(g_\#)_0(P_2)=Q_1-Q_4=\partial_1[Q_4,Q_1]
\]
\[
    (f_\#)_0(P_2)-(g_\#)_0(P_2)=Q_2-Q_5=\partial_1[Q_5,Q_2]
\]
(se il complesso immagine è connesso, ogni coppia di funzioni undice lo stesso omomorfismo tra gli 0-esimi gruppi di omologia)
...
%Shape: Polygon [id:ds5342942412692322] 
\draw  [draw opacity=0][fill={rgb, 255:red, 155; green, 155; blue, 155 }  ,fill opacity=1 ] (390,52.5) -- (403.5,149.5) -- (288.5,149.5) -- (191,95.5) -- (275,52.5) -- cycle ;
%Straight Lines [id:da8534575157718434] 
\draw    (191,95.5) -- (275,52.5) ;
\draw [shift={(275,52.5)}, rotate = 332.89] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(191,95.5)}, rotate = 332.89] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da1637095784343361] 
\draw    (288.5,149.5) -- (191,95.5) ;
\draw [shift={(191,95.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(288.5,149.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da030526274938948328] 
\draw    (275,52.5) -- (288.5,149.5) ;
\draw [shift={(288.5,149.5)}, rotate = 82.08] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(275,52.5)}, rotate = 82.08] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da4245704012947664] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (306,95.5) -- (390,52.5) ;
\draw [shift={(390,52.5)}, rotate = 332.89] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(306,95.5)}, rotate = 332.89] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da33823835536111346] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (403.5,149.5) -- (306,95.5) ;
\draw [shift={(306,95.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(403.5,149.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da9133491311064148] 
\draw    (390,52.5) -- (403.5,149.5) ;
\draw [shift={(403.5,149.5)}, rotate = 82.08] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(390,52.5)}, rotate = 82.08] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da532793372684391] 
\draw    (275,52.5) -- (390,52.5) ;
%Straight Lines [id:da4008252813501427] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (191,95.5) -- (306,95.5) ;
%Straight Lines [id:da2888913533115496] 
\draw    (288.5,149.5) -- (403.5,149.5) ;
%Straight Lines [id:da6964303388545676] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (191,95.5) -- (403.5,149.5) ;
%Straight Lines [id:da6139520980020683] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (275,52.5) -- (306,95.5) ;
%Straight Lines [id:da5548093922178561] 
\draw    (390,52.5) -- (288.5,149.5) ;
%Straight Lines [id:da9583109298466892] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (191,95.5) -- (237.13,121.05) ;
\draw [shift={(239.75,122.5)}, rotate = 208.98] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (14.21,-4.28) .. controls (9.04,-1.82) and (4.3,-0.39) .. (0,0) .. controls (4.3,0.39) and (9.04,1.82) .. (14.21,4.28)   ;
%Straight Lines [id:da8361438191804971] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (403.5,149.5) -- (357.37,123.95) ;
\draw [shift={(354.75,122.5)}, rotate = 28.98] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (14.21,-4.28) .. controls (9.04,-1.82) and (4.3,-0.39) .. (0,0) .. controls (4.3,0.39) and (9.04,1.82) .. (14.21,4.28)   ;

% Text Node
\draw (163.5,85.4) node [anchor=north west][inner sep=0.75pt]    {$Q_{0}$};
% Text Node
\draw (278,159.9) node [anchor=north west][inner sep=0.75pt]    {$Q_{1}$};
% Text Node
\draw (263,26.9) node [anchor=north west][inner sep=0.75pt]    {$Q_{2}$};
% Text Node
\draw (301,67.4) node [anchor=north west][inner sep=0.75pt]    {$Q_{3}$};
% Text Node
\draw (408.5,156.9) node [anchor=north west][inner sep=0.75pt]    {$Q_{4}$};
% Text Node
\draw (390.5,29.9) node [anchor=north west][inner sep=0.75pt]    {$Q_{5}$};


\end{tikzpicture}
\end{center}
Sono due lati della faccia inferiore, un buon candidato per $d'_1$ è 
\[
    d'_1=[Q_0,Q_1,Q_4]-[Q_0,Q_3,Q_4]    
\]
Controllo il bordo
\[
    \partial_2 d'_1=[Q_1,Q_4]\cancel{-[Q_0,Q_4]}+[Q_0,Q_1]-([Q_3,Q_4]\cancel{-[Q_0,Q_4]}+[Q_0,Q_3])=
\]
\[
    [Q_1,Q_4]+[Q_0,Q_1]-[Q_3,Q_4]-[Q_0,Q_3]    
\]
che corrisponde a
\begin{center}
...
\draw [shift={(191,95.5)}, rotate = 332.89] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da1637095784343361] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ]   (288.5,149.5) -- (191,95.5) ;
\draw [shift={(191,95.5)}, rotate = 208.98] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][fill={rgb, 255:red, 208; green, 2; blue, 27 }  ,fill opacity=1 ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(288.5,149.5)}, rotate = 208.98] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][fill={rgb, 255:red, 208; green, 2; blue, 27 }  ,fill opacity=1 ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da030526274938948328] 
\draw    (275,52.5) -- (288.5,149.5) ;
\draw [shift={(288.5,149.5)}, rotate = 82.08] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(275,52.5)}, rotate = 82.08] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
...
\draw [shift={(306,95.5)}, rotate = 332.89] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da33823835536111346] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ] [dash pattern={on 0.84pt off 2.51pt}]  (403.5,149.5) -- (306,95.5) ;
\draw [shift={(306,95.5)}, rotate = 208.98] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][fill={rgb, 255:red, 208; green, 2; blue, 27 }  ,fill opacity=1 ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(403.5,149.5)}, rotate = 208.98] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][fill={rgb, 255:red, 208; green, 2; blue, 27 }  ,fill opacity=1 ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da9133491311064148] 
\draw    (390,52.5) -- (403.5,149.5) ;
\draw [shift={(403.5,149.5)}, rotate = 82.08] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(390,52.5)}, rotate = 82.08] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
...
\draw    (275,52.5) -- (390,52.5) ;
%Straight Lines [id:da4008252813501427] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ] [dash pattern={on 0.84pt off 2.51pt}]  (191,95.5) -- (306,95.5) ;
%Straight Lines [id:da2888913533115496] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ]   (288.5,149.5) -- (403.5,149.5) ;
%Straight Lines [id:da6964303388545676] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (191,95.5) -- (403.5,149.5) ;
%Straight Lines [id:da6139520980020683] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (275,52.5) -- (306,95.5) ;
...
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (403.5,149.5) -- (357.37,123.95) ;
\draw [shift={(354.75,122.5)}, rotate = 28.98] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (14.21,-4.28) .. controls (9.04,-1.82) and (4.3,-0.39) .. (0,0) .. controls (4.3,0.39) and (9.04,1.82) .. (14.21,4.28)   ;
%Straight Lines [id:da14285708360743343] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (288.5,149.5) -- (343,149.5) ;
\draw [shift={(346,149.5)}, rotate = 180] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (14.21,-4.28) .. controls (9.04,-1.82) and (4.3,-0.39) .. (0,0) .. controls (4.3,0.39) and (9.04,1.82) .. (14.21,4.28)   ;
%Straight Lines [id:da15654584146791573] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (306,95.5) -- (251.5,95.5) ;
\draw [shift={(248.5,95.5)}, rotate = 360] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (14.21,-4.28) .. controls (9.04,-1.82) and (4.3,-0.39) .. (0,0) .. controls (4.3,0.39) and (9.04,1.82) .. (14.21,4.28)   ;
...
\end{center}
\paragraph{$\mathbf{[Q_1,Q_2]-[Q_4,Q_5]}$}
\begin{center}
...
\draw    (390,52.5) -- (288.5,149.5) ;
%Straight Lines [id:da9583109298466892] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (288.5,149.5) -- (282.16,103.97) ;
\draw [shift={(281.75,101)}, rotate = 82.08] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (14.21,-4.28) .. controls (9.04,-1.82) and (4.3,-0.39) .. (0,0) .. controls (4.3,0.39) and (9.04,1.82) .. (14.21,4.28)   ;
%Straight Lines [id:da8361438191804971] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (390,52.5) -- (396.34,98.03) ;
\draw [shift={(396.75,101)}, rotate = 262.08] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (14.21,-4.28) .. controls (9.04,-1.82) and (4.3,-0.39) .. (0,0) .. controls (4.3,0.39) and (9.04,1.82) .. (14.21,4.28)   ;
...
\end{center}
Sono due lati della faccia davanti, un buon candidato per $d'_2$ è
\[
    d'_2=[Q_1,Q_2,Q_5]-[Q_1,Q_4,Q_5]    
\]
Controllo il bordo
\[
    \partial_2 d'_2=[Q_2,Q_5]\cancel{-[Q_1,Q_5]}+[Q_1,Q_2]-([Q_4,Q_5]\cancel{-[Q_1,Q_5]}+[Q_1,Q_4])=
\]
\[
    [Q_2,Q_5]+[Q_1,Q_2]-[Q_4,Q_5]-[Q_1,Q_4]    
\]
che corrisponde a
\begin{center}
...
\draw [shift={(288.5,149.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da030526274938948328] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ]   (275,52.5) -- (288.5,149.5) ;
\draw [shift={(288.5,149.5)}, rotate = 82.08] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][fill={rgb, 255:red, 208; green, 2; blue, 27 }  ,fill opacity=1 ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(275,52.5)}, rotate = 82.08] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][fill={rgb, 255:red, 208; green, 2; blue, 27 }  ,fill opacity=1 ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da4245704012947664] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (306,95.5) -- (390,52.5) ;
\draw [shift={(390,52.5)}, rotate = 332.89] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(306,95.5)}, rotate = 332.89] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
...
\draw [shift={(403.5,149.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da9133491311064148] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ]   (390,52.5) -- (403.5,149.5) ;
\draw [shift={(403.5,149.5)}, rotate = 82.08] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][fill={rgb, 255:red, 208; green, 2; blue, 27 }  ,fill opacity=1 ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(390,52.5)}, rotate = 82.08] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][fill={rgb, 255:red, 208; green, 2; blue, 27 }  ,fill opacity=1 ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da532793372684391] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ]   (275,52.5) -- (390,52.5) ;
%Straight Lines [id:da4008252813501427] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (191,95.5) -- (306,95.5) ;
%Straight Lines [id:da2888913533115496] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ]   (288.5,149.5) -- (403.5,149.5) ;
...
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (390,52.5) -- (396.34,98.03) ;
\draw [shift={(396.75,101)}, rotate = 262.08] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (14.21,-4.28) .. controls (9.04,-1.82) and (4.3,-0.39) .. (0,0) .. controls (4.3,0.39) and (9.04,1.82) .. (14.21,4.28)   ;
%Straight Lines [id:da9557227327259712] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (275,52.5) -- (329.5,52.5) ;
\draw [shift={(332.5,52.5)}, rotate = 180] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (14.21,-4.28) .. controls (9.04,-1.82) and (4.3,-0.39) .. (0,0) .. controls (4.3,0.39) and (9.04,1.82) .. (14.21,4.28)   ;
%Straight Lines [id:da005067770785718739] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (403.5,149.5) -- (349,149.5) ;
\draw [shift={(346,149.5)}, rotate = 360] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (14.21,-4.28) .. controls (9.04,-1.82) and (4.3,-0.39) .. (0,0) .. controls (4.3,0.39) and (9.04,1.82) .. (14.21,4.28)   ;
...
\end{center}
\paragraph{$\mathbf{-[Q_0,Q_2]+[Q_3,Q_5]}$}
\begin{center}
...
\draw    (390,52.5) -- (288.5,149.5) ;
%Straight Lines [id:da9583109298466892] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (275,52.5) -- (235.67,72.63) ;
\draw [shift={(233,74)}, rotate = 332.89] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (14.21,-4.28) .. controls (9.04,-1.82) and (4.3,-0.39) .. (0,0) .. controls (4.3,0.39) and (9.04,1.82) .. (14.21,4.28)   ;
%Straight Lines [id:da8361438191804971] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]  [dash pattern={on 1.69pt off 2.76pt}]  (306,95.5) -- (345.33,75.37) ;
\draw [shift={(348,74)}, rotate = 152.89] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (14.21,-4.28) .. controls (9.04,-1.82) and (4.3,-0.39) .. (0,0) .. controls (4.3,0.39) and (9.04,1.82) .. (14.21,4.28)   ;
...
\end{center}
Sono due lati della faccia posteriore, un buon candidato per $d'_3$ è
\[
    d'_3=[Q_2,Q_3,Q_5]-[Q_0,Q_2,Q_3]    
\]
Controllo il bordo
\[
    \partial_2 d'_3=[Q_3,Q_5]-[Q_2,Q_5]\cancel{+[Q_2,Q_3]}-(\cancel{[Q_2,Q_3]}-[Q_0,Q_3]+[Q_0,Q_2])
\]
\[
    [Q_3,Q_5]-[Q_2,Q_5]+[Q_0,Q_3]-[Q_0,Q_2]    
\]
che corrisponde a
\begin{center}
...
\draw  [draw opacity=0][fill={rgb, 255:red, 155; green, 155; blue, 155 }  ,fill opacity=1 ] (390,52.5) -- (403.5,149.5) -- (288.5,149.5) -- (191,95.5) -- (275,52.5) -- cycle ;
%Straight Lines [id:da8534575157718434] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ]   (191,95.5) -- (275,52.5) ;
\draw [shift={(275,52.5)}, rotate = 332.89] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][fill={rgb, 255:red, 208; green, 2; blue, 27 }  ,fill opacity=1 ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(191,95.5)}, rotate = 332.89] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][fill={rgb, 255:red, 208; green, 2; blue, 27 }  ,fill opacity=1 ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da1637095784343361] 
\draw    (288.5,149.5) -- (191,95.5) ;
\draw [shift={(191,95.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(288.5,149.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
...
\draw [shift={(275,52.5)}, rotate = 82.08] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da4245704012947664] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ] [dash pattern={on 0.84pt off 2.51pt}]  (306,95.5) -- (390,52.5) ;
\draw [shift={(390,52.5)}, rotate = 332.89] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][fill={rgb, 255:red, 208; green, 2; blue, 27 }  ,fill opacity=1 ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(306,95.5)}, rotate = 332.89] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][fill={rgb, 255:red, 208; green, 2; blue, 27 }  ,fill opacity=1 ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da33823835536111346] 
\draw  [dash pattern={on 0.84pt off 2.51pt}]  (403.5,149.5) -- (306,95.5) ;
\draw [shift={(306,95.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(403.5,149.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
...
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]  [dash pattern={on 1.69pt off 2.76pt}]  (306,95.5) -- (345.33,75.37) ;
\draw [shift={(348,74)}, rotate = 152.89] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (14.21,-4.28) .. controls (9.04,-1.82) and (4.3,-0.39) .. (0,0) .. controls (4.3,0.39) and (9.04,1.82) .. (14.21,4.28)   ;
%Straight Lines [id:da9772255919798745] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (390,52.5) -- (335.5,52.5) ;
\draw [shift={(332.5,52.5)}, rotate = 360] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (14.21,-4.28) .. controls (9.04,-1.82) and (4.3,-0.39) .. (0,0) .. controls (4.3,0.39) and (9.04,1.82) .. (14.21,4.28)   ;
%Straight Lines [id:da434649304336034] 
\draw [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]  [dash pattern={on 1.69pt off 2.76pt}]  (191,95.5) -- (245.5,95.5) ;
\draw [shift={(248.5,95.5)}, rotate = 180] [color={rgb, 255:red, 208; green, 2; blue, 27 }  ,draw opacity=1 ][line width=1.5]    (14.21,-4.28) .. controls (9.04,-1.82) and (4.3,-0.39) .. (0,0) .. controls (4.3,0.39) and (9.04,1.82) .. (14.21,4.28)   ;
...
Sommando i vari termini otteniamo
\[
    \partial_2(d'_1+d'_2+d'_3)=
\]
\[
    \cancel{[Q_1,Q_4]}+[Q_0,Q_1]-[Q_3,Q_4]\cancel{-[Q_0,Q_3]}\cancel{+[Q_2,Q_5]}+[Q_1,Q_2]-[Q_4,Q_5]\cancel{-[Q_1,Q_4]}+
\]
\[
    +[Q_3,Q_5]\cancel{-[Q_2,Q_5]}\cancel{+[Q_0,Q_3]}-[Q_0,Q_2]=
\]
\[
    =[Q_0,Q_1]-[Q_3,Q_4]+[Q_1,Q_2]-[Q_4,Q_5]+[Q_3,Q_5]-[Q_0,Q_2]=    
\]
\[
    =(f_\#)_1([P_0,P_1]+[P_1,P_2]-[P_0,P_2])-(g_\#)_1([P_0,P_1]+[P_1,P_2]-[P_0,P_2])    
\]
...
\[
    (f_*)_1=(g_*)_1    
\]
Questo procedimento è però poco generalizzabile, in quanto dovremmo conoscere la natura geometrica del simplesso, cosa che non è sempre possibile
\chapter{Chain Homotopy}
\begin{definition}[Chain homotopy]
    Siano $f,g:K\ra L$ due mappe simpliciali. Una collezione di omomorfismi
    \[
        D_p:C_p(K)\ra C_{p+1}(L)    
    \]
    tali che
    \[
        \shrp{g}-\shrp{f}=\partial_{p+1}\circ D_p+ D_{p+1}\circ \partial_p    
    \]
    si dice chain homotopy tra $f_\#$ e $g_\#$
    \begin{center}
        \[\begin{tikzcd}
            \dots & {C_{p+1}(K)} && {C_{p}(K)} && {C_{p-1}(K)} & \dots \\
            \\
            \dots & {C_{p+1}(L)} && {C_{p}(L)} && {C_{p-1}(L)} & \dots
            \arrow["{(g_\#)_p-(f_\#)_p}"{description}, from=1-4, to=3-4]
            \arrow["{\partial_p}", from=1-4, to=1-6]
            \arrow["{\partial'_p}"', from=3-4, to=3-6]
            \arrow["{D_{p-1}}", from=1-6, to=3-4]
            \arrow["{D_p}"', from=1-4, to=3-2]
            \arrow["{\partial_{p+1}}", from=1-2, to=1-4]
            \arrow["{\partial'_{p+1}}"', from=3-2, to=3-4]
            \arrow[from=1-6, to=1-7]
            \arrow[from=3-6, to=3-7]
            \arrow[from=1-1, to=1-2]
            \arrow[from=3-1, to=3-2]
            \arrow["{(g_\#)_{p-1}-(f_\#)_{p-1}}", from=1-6, to=3-6]
            \arrow["{(g_\#)_{p+1}-(f_\#)_{p+1}}"', from=1-2, to=3-2]
        \end{tikzcd}\]
    \end{center}
\end{definition}
\begin{theorem}
    Siano $f,g:K\ra L$ due mappe simpliciali e sia $D$ una chain homotopy tra $f_\#$ e $g_\#$.\\
    Allora gli omomorfismi indotti sui gruppi di omologia coincidono
    \[
        f_*=g_*    
    \]
\end{theorem}
\begin{proof}
    Devo far vedere che
    \[
        \forall z\in Z_p(K)\exists d\in C_{p+1}(L)\ t.c.\ \partial_{p+1}d=\shrp{g}-\shrp{f} 
    \]
    Considero $d=B_p(z)$
    \[
        z\in Z_p(K)\implies \partial_p z=0\implies D_{p-1}(\partial_p(z))=0    
    \]
    Calcolo $\partial_{p+1}d$
    \[
        \partial_{p+1}d=\partial_{p+1}(D_p(z))=\partial_{p+1}+0=    
    \]
    \[
        =\partial_{p+1}(D_p(z))+D_{p-1}(\partial_p(z))=    
    \]
    \[
        \left(\partial_{p+1}\circ D_p+D_{p-1}\circ \partial_p\right)(z)=\shrp{g}-\shrp{f}    
    \]
\end{proof}
\paragraph{Esempio} (Esempio del prisma)
\begin{center}
    \[\begin{tikzcd}
        {\{0\}} & {C_2(K)} && {C_1(K)} && {C_0(K)} & {\{0\}} \\
        \\
        {\{0\}} & {C_2(L)} && {C_1(L)} && {C_0(L)} & {\{0\}}
        \arrow["{(g_\#)_1-(f_\#)_1}"{description}, from=1-4, to=3-4]
        \arrow["{\partial_1}", from=1-4, to=1-6]
        \arrow["{\partial'_1}"', from=3-4, to=3-6]
        \arrow["{D_{0}}", from=1-6, to=3-4]
        \arrow["{D_1}"', from=1-4, to=3-2]
        \arrow["{\partial'_{2}}"', from=3-2, to=3-4]
        \arrow[from=1-6, to=1-7]
        \arrow[from=3-6, to=3-7]
        \arrow[from=1-1, to=1-2]
        \arrow[from=3-1, to=3-2]
        \arrow["{(g_\#)_{0}-(f_\#)_{0}}", from=1-6, to=3-6]
        \arrow["{(g_\#)_{2}-(f_\#)_{2}}"', from=1-2, to=3-2]
        \arrow["{\partial_2}", from=1-2, to=1-4]
    \end{tikzcd}\]
\end{center}
\[
    D_0:C_0(K)=\gen{P_0,P_1,P_2}\ra C_1(L)\simeq \Z^{12}    
\]
\[
    D_0(P_0)=d_0=[Q_0,Q_3]
\]
...
\]
\[
    D_1:C_1(K)=\gen{[P_0,P_1],[P_0,P_2],[P_0,P_2]}\ra C_2(L)\simeq \Z^6    
\]
\[
    D_1([P_0,P_1])=d'_1=[Q_0,Q_1,Q_4]-[Q_0,Q_3,Q_4]    
\]
\[
    D_1([P_0,P_2])=d'_2=[Q_1,Q_2,Q_5]-[Q_1,Q_4,Q_5]    
\]
\[
    D_1([P_1,P_2])=d'_3=[Q_0,Q_2,Q_3]-[Q_2,Q_3,Q_5]    
\]
tale che
\[
    D_1([P_0,P_1]+[P_0,P_2]-[P_0,P_2])=(g_\#)_1-(f_\#)_1([P_0,P_1]+[P_0,P_2]-[P_0,P_2])    
\]
Costruire una chain homotopy in generale è un problema molto complicato, quasi impossibile senza conoscere la natura geometrica del complesso simpliciale
\part{Approssimazioni con complessi simpliciali}
\chapter{Mappe simpliciali contigue}
Abbiamo un nuovo obiettivo, ossia trovare una proprietà più forte che permette di dire quando due mappe simpliciali inducono gli stessi omomorfismi tra i gruppi di omologia
\paragraph{Idea} Ci aspettiamo che gli omomorfismi indotti tra i gruppi di omologia coincidano se le due mappe simpliciali sono "simili"
\begin{definition}[Mappe simpliciali contigue]
    Siano $f,g:K\ra L$ due mappe simpliciali, $f$ e $g$ si dicono contigue se per ogni p-simplesso $\sigma=[P_0,\dots,P_p]$ di $K$, i vertici che ottengo come
    \[
        f(P_0),\dots,f(P_P),g(P_0),\dots,g(P_p)    
    \]
    descrivono un simplesso $\tau$ di $L$
\end{definition}
\paragraph{Osservazioni}
\begin{itemize}
    \item $0\leq dim\ \tau\leq 2p+1$
    \item Prendiamo $f$ e $g$ contigue, allora $\forall \sigma\in K$, $f(\sigma)$ e $g(\sigma)$ sono vicini, infatti sono facce dello stesso compleeso $\tau$ in $L$
\end{itemize}
\section{Esempio}
\begin{center}
...
%Shape: Polygon [id:ds3625927064432801] 
\draw  [draw opacity=0][fill={rgb, 255:red, 155; green, 155; blue, 155 }  ,fill opacity=1 ] (481,149.5) -- (383.5,95.5) -- (477.5,30) -- cycle ;
%Straight Lines [id:da1637095784343361] 
\draw    (225.5,149.5) -- (128,95.5) ;
\draw [shift={(128,95.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(225.5,149.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da030526274938948328] 
\draw    (222,30) -- (225.5,149.5) ;
\draw [shift={(225.5,149.5)}, rotate = 88.32] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(222,30)}, rotate = 88.32] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da4968765297414328] 
\draw    (222,30) -- (128,95.5) ;
\draw [shift={(128,95.5)}, rotate = 145.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(222,30)}, rotate = 145.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da6353038704109311] 
\draw    (128,95.5) -- (173.36,63.89) ;
\draw [shift={(175,62.75)}, rotate = 145.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da4128376863232184] 
\draw    (128,95.5) -- (175,121.53) ;
\draw [shift={(176.75,122.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da9712395939801575] 
\draw    (225.5,149.5) -- (223.81,91.75) ;
\draw [shift={(223.75,89.75)}, rotate = 88.32] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da6162201266522751] 
\draw    (481,149.5) -- (383.5,95.5) ;
\draw [shift={(383.5,95.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(481,149.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da048840333847345097] 
\draw    (477.5,30) -- (481,149.5) ;
\draw [shift={(481,149.5)}, rotate = 88.32] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(477.5,30)}, rotate = 88.32] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da7754209450247553] 
\draw    (477.5,30) -- (383.5,95.5) ;
\draw [shift={(383.5,95.5)}, rotate = 145.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
\draw [shift={(477.5,30)}, rotate = 145.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][fill={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0, 0) circle [x radius= 3.35, y radius= 3.35]   ;
%Straight Lines [id:da08810554284583061] 
\draw    (383.5,95.5) -- (428.86,63.89) ;
\draw [shift={(430.5,62.75)}, rotate = 145.13] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da6180479890752333] 
\draw    (383.5,95.5) -- (430.5,121.53) ;
\draw [shift={(432.25,122.5)}, rotate = 208.98] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da9255682696898444] 
\draw    (481,149.5) -- (479.31,91.75) ;
\draw [shift={(479.25,89.75)}, rotate = 88.32] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Shape: Boxed Bezier Curve [id:dp9383062658765742] 
\draw    (435.85,79.5) .. controls (406.65,108.21) and (481.82,108.01) .. (447.91,80.83) ;
\draw [shift={(446.85,80)}, rotate = 37.49] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;

% Text Node
\draw (100.5,85.4) node [anchor=north west][inner sep=0.75pt]    {$P_{0}$};
% Text Node
\draw (233,159.9) node [anchor=north west][inner sep=0.75pt]    {$P_{1}$};
% Text Node
\draw (213.5,7.4) node [anchor=north west][inner sep=0.75pt]    {$P_{2}$};
% Text Node
\draw (356,85.4) node [anchor=north west][inner sep=0.75pt]    {$P_{0}$};
% Text Node
\draw (488.5,159.9) node [anchor=north west][inner sep=0.75pt]    {$P_{1}$};
% Text Node
\draw (469,7.4) node [anchor=north west][inner sep=0.75pt]    {$P_{2}$};
% Text Node
\draw (343.5,13.4) node [anchor=north west][inner sep=0.75pt]    {$L$};
% Text Node
\draw (72,12.9) node [anchor=north west][inner sep=0.75pt]    {$K$};
...
\end{center}
\[
    f:K\ra L\quad P_0\longmapsto Q_0\quad P_1\longmapsto Q_1\quad P_2\longmapsto Q_2    
\]
\[
    g:K\ra L\quad P_0\longmapsto Q_0\quad P_1\longmapsto Q_1\quad P_2\longmapsto Q_1   
\]
$f$ e $g$ sono contigue?
\paragraph{$\mathbf{0-simplessi}$}
\[
    \{P_0\}\in K\longrightarrow f(P_0),g(P_0)=\{Q_0\}\in L    
\]
\[
    \{P_1\}\in K\longrightarrow f(P_1),g(P_1)=\{Q_1\}\in L    
\]
\[
    \{P_2\}\in K\longrightarrow f(P_2),g(P_2)=\{Q_1,Q_2\}\in L    
\]
\paragraph{$\mathbf{1-simplessi}$}
\[
    [P_0,P_1]\in K\longrightarrow f(P_0),f(P_1),g(P_0),g(P_1)=[Q_0,Q_1]\in L    
\]
\[
    [P_1,P_2]\in K\longrightarrow f(P_1),f(P_2),g(P_1),g(P_2)=[Q_1,Q_2]\in L    
\]
\[
    [P_0,P_2]\in K\longrightarrow f(P_0),f(P_2),g(P_0),g(P_2)=[Q_0,Q_2]\in L    
\]
$f$ e $g$ sono contigue
\section{Esempio (del prisma)}
E' immediato verificare che le due mappe non sono contigue, infatti
\[
    [P_0,P_1]\in K\longrightarrow f(P_0),f(P_1),g(P_0),g(P_1)=\{Q_0,Q_1,Q_3,Q_4\}\notin L
\]
Nonostante le mappe non siano contigue, inducono comunque gli stessi omomorfismi sui gruppi di omologia
\begin{theorem}
    Siano $f,g:K\ra L$ due mappe simpliciali contigue. Allora esiste una chain homotopy tra $f_\#$ e $g_\#$
\end{theorem}
\begin{proof}
    Dimostrazione per induzione
    \paragraph{Base dell'induzione} Voglio costruire un $D_0:C_0(K)\ra C_1(L)$ tale che $(g_\#)_0-(f_\#)_0=\partial_1\circ D_0+\cancel{D_{-1}\circ\partial_0}$\\
    Considero un vertice $P$ di $K$. Per ipotesi ci sono due casi
    \[
        g(P)=f(P)    
    \]
    \[
        g(P)\neq f(P)\quad[f(P),g(P)]\in L    
    \]
    Se sono nel primo caso, allora $D_0(P)=0$ poichè $(g_\#)_0-(f_\#)_0=0$\\
    Se sono nel secondo caso, allora $D_0(P)=[f(P),g(P)]$ poichè
    \[
        \partial_1\circ D_0=g(P)-f(P)=\left((g_\#)_0-(f_\#)_0\right)(P)   
    \]
    \paragraph{Passo induttivo}
    Supponiamo che siamo riusciti a determinare $D_q:C_q(K)\ra C_{q+1}(L)$ per $0\leq q\leq p-1$\\
    Voglio costruire $D_p:C_p(K)\ra C_{p+1}(L)$ tale che
    \[
        (g_\#)_p-(f_\#)_p=\partial_{p+1}\circ D_p+D_{p-1}\circ\partial_p    
    \]
    Sia $\sigma=[P_0,\dots,P_p]$ un p-simplesso di $K$. Indichiamo con $L(\sigma)$ il sottocomplesso di $L$ corrispondente al simplesso generato da $f(P_0),\dots,f(P_p),g(P_0),\dots,g(P_p)$ (che per contiguità esiste sempre)\\
    Risultano immediate le seguenti proprietà
    \begin{itemize}
        \item $L(\sigma)\neq\emptyset$
        \item $\tilde{H_i}(L(\sigma))=\{0\}$
        \item $\shrp{f}(sigma)$ e $\shrp{g}(\sigma)$ valgono $0$, oppure sono funzioni caratteristiche di simplessi che compaiono tra le facce di $L(\sigma)$
    \end{itemize}
    Voglio determinare $D_p(\sigma)$ in modo che
    \[
        (\partial_{p+1}\circ D_p)(\sigma)=(\shrp{g}-\shrp{f})(\sigma)-(D_{p-1}\circ\partial_p)(\sigma)  
    \]
    Per induzione
    \[
        =(\shrp{g}-\shrp{f})(\sigma)-(D_{p-1}\circ\partial_p)(\sigma)  
    \]
    è univocamente determinata.\\
    Calcoliamo il bordo $\partial c$
    \[
        (\partial_p\circ\shrp{g})(\sigma)-(\partial_p\circ\shrp{f})(\sigma)-(\partial_p\circ D_{p-1}\circ\partial_p)(\sigma)=
    \]
    \[
        =(\partial_p\circ\shrp{g})(\sigma)-(\partial_p\circ\shrp{f})(\sigma)-(\partial_p\circ D_{p-1})\circ(\partial_p)(sigma)=(*)
    \]
    ...
    \[
        \partial_p\circ D_{p-1}=(g_\#)_{p-1}-(f_\#)_{p-1}-D_{p-2}\circ\partial_{p-1} 
    \]
    da cui otteniamo
    \[
        (*)=(\partial_p\circ(g_\#)_p)(\sigma)-(\partial_p\circ(f_\#)_p)(\sigma)-((g_\#)_{p-1}\circ\partial_p)+((f_\#)_{p-1}\circ\partial_p)(\sigma)
    \]
    \[
        \cancelto{0}{-(D_{p-2}\circ \partial_{p-1}\partial_p)(\sigma)}=   
    \]
    \[
        =(\partial_p\circ\shrp{g})(\sigma)-((g_\#)_{p-1}\circ\partial_p)(\sigma)    
    \]
    \[
        -\left[(\partial_p\circ\shrp{f})(\sigma)-((f_\#)_{p-1}\circ\partial_p)(\sigma)\right]=0-0=0    
    \]
    da cui
    \[
        \partial c=0\Longleftrightarrow c\in Z_p(L(\sigma))\subseteq Z_p(L)    
    \]
    Inoltre
    \[
        H_p(L(\sigma))=\{0\}=\faktor{Z_p(L(\sigma))}{B_p(L(\sigma))}    
    \]
    Dato che $\tilde{H_p}(L(\sigma))=\{0\}$, abbiamo che
    \[
        Z_p(L(\sigma))=B_p(L(\sigma))    
    \]
    Quindi
    \[
        \exists d\in C_{p+1}(L(\sigma))\subset C_{p+1}(L)\quad t.c.\quad c=\partial_{p+1}d    
    \]
    \[
        (\partial_{p+1}\circ D_p)(\sigma)=c=\partial_{p+1}d\implies D_p(\sigma)=d    
    \]
\end{proof}
\paragraph{Osservazione} Il passaggio chiave è l'esistenza di un sottocomplesso $L(\sigma)$ aciclico, che contenga i vertici che identifico con
\[
    f(P_0),\dots,f(P_p),g(P_0),\dots,g(P_p)    
\]
La contiguità è più forte che garantire che $L(\sigma)$ sia aciclico.\\
Ma se pensiamo all'esempio del prisma a base triangolare, se considero
\[
    L([P_0,P_1])=\{[Q_0,Q_1,Q_3],[Q_1,Q_3,Q_4]\}\cup\{\text{facce}\}    
\]
è aciclico, quindi
\[
    Z_1(L([P_0,P_1]))=B_1(L([P_0,P_1]))    
\]
\chapter{Funzioni continue qualsiasi}
In generale, mi posso trovare a studiare funzioni continue $f:X\ra Y$ tra spazi topologici $X\subseteq\R^n$ $Y\subseteq\R^m$ con obiettivi computazionali non banali.\\
Una possibilità è quella di considerare due complessi simpliciali $K$ e $L$ tali che
\[
    |K|\subset\R^n\quad L\subset\R^m
\]
Ad esempio
\begin{center}
...
%Shape: Polygon [id:ds2626602337732131] 
\draw   (371.5,58) -- (390.5,62.5) -- (410,82) -- (414.88,101.38) -- (409.5,123) -- (391.5,139.5) -- (371.5,144.75) -- (351.5,140) -- (335,124.75) -- (328.13,101.38) -- (333.5,80.75) -- (349.5,64.25) -- cycle ;
%Straight Lines [id:da32714644293663175] 
\draw    (140,171) -- (140,31.75) ;
\draw [shift={(140,29.75)}, rotate = 90] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Shape: Boxed Line [id:dp2632510770906993] 
\draw    (69.38,99.88) -- (208.63,99.88) ;
\draw [shift={(210.63,99.88)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Shape: Circle [id:dp5931492243245413] 
\draw   (96.63,100.38) .. controls (96.63,76.42) and (116.04,57) .. (140,57) .. controls (163.96,57) and (183.38,76.42) .. (183.38,100.38) .. controls (183.38,124.33) and (163.96,143.75) .. (140,143.75) .. controls (116.04,143.75) and (96.63,124.33) .. (96.63,100.38) -- cycle ;
%Straight Lines [id:da353234324383608] 
\draw    (371.5,172) -- (371.5,32.75) ;
\draw [shift={(371.5,30.75)}, rotate = 90] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Shape: Boxed Line [id:dp306445924214406] 
\draw    (300.88,100.88) -- (440.13,100.88) ;
\draw [shift={(442.13,100.88)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
%Straight Lines [id:da4439943191009972] 
\draw    (333.5,80.75) -- (371.5,101.38) ;
%Straight Lines [id:da3622140751869001] 
\draw    (371.5,101.38) -- (409.5,123) ;
%Straight Lines [id:da44438408064971635] 
\draw    (349.5,64.25) -- (371.5,101.38) ;
%Straight Lines [id:da5661658953728566] 
\draw    (371.5,101.38) -- (391.5,139.5) ;
%Straight Lines [id:da7370115000329436] 
\draw    (390.5,62.5) -- (371.5,101.38) ;
%Straight Lines [id:da7674882100427609] 
\draw    (410,82) -- (371.5,101.38) ;
%Straight Lines [id:da08138200405890528] 
\draw    (335,124.75) -- (371.5,101.38) ;
%Straight Lines [id:da9053798560761808] 
\draw    (371.5,101.38) -- (351.5,140) ;

% Text Node
\draw (90.5,132.4) node [anchor=north west][inner sep=0.75pt]    {$X$};
% Text Node
\draw (187,33.4) node [anchor=north west][inner sep=0.75pt]    {$\mathbb{R}^{2}$};
% Text Node
\draw (319.5,133.9) node [anchor=north west][inner sep=0.75pt]    {$K$};
% Text Node
\draw (194.5,170.9) node [anchor=north west][inner sep=0.75pt]    {$|K|\ approssima\ X$};


\end{tikzpicture}

\end{center}
Osservo che in generale $f$ non sarà una mappa simpliciale tra $K$ e $L$, infatti non posso garantire che mandi simplessi in simplessi
\paragraph{Obiettivo} Studiare funzioni continue $f:|K|\ra |L|$ che non corrispondono a mappe simpliciali
\begin{definition}[Condizione star]
    Sia $h:|K|\ra |L|$ una funzione continua, diciamo che $h$ soddisfa la condizione star (rispetto alla struttura combinatoriale di $K$ e $L$) se per ogni vertice $P\in\pskel{K}{0}$ c'è un vertice $Q\in\pskel{L}{0}$ tale che
    \[
        h(St(P,K))\subset St(Q,L)    
    \]
\end{definition}
\newpage
\begin{proposition}
    Sia $h:|K|\ra |L|$ una funzione continua che soddisfa la condizione star e sia $f:\pskel{K}{0}\ra\pskel{L}{0}$ una funzione tale che
    \[
        \forall P\in\pskel{K}{0}\quad h(St(P,K))\subset St(f(P),L)    
    \]
    ($f$ esiste per forza poichè $h$ soddisfa la condizione star)
    Allora:
    \begin{itemize}
        \item Dato $\sigma\in K$, sia $x\in Int(\sigma)$ e sia $\tau\in L$ tal che $h(x)\in Int(\tau)$, allora la funzione $f$ manda vertici di $\sigma$ in vertici di $\tau$
        \item $f$ si può estendere ad una mappa simpliciale $f:K\ra L$
        \item Sia $g:K\ra L$ un'altra mappa simpliciale tale che
        \[
            h(St(P,K))\subset St(g(P),L)\quad\forall P\in\pskel{K}{0}
        \]
        Allora $f$ e $g$ sono contigue
    \end{itemize}
\end{proposition}
\paragraph{Morale} Una volta fissata $h$, l'effetto di una mappa simpliciale $f:K\ra L$  tale che $h(St(P,K))\subset St(f(P),K)$ sui gruppi di omologia è univocamente determinata
\begin{definition}[Approssimazione simpliciale]
    Sia $h:|K|\ra|L|$ una funzione continua che soddisfa la condizione star. Una mappa simpliciale $f:K\ra L$ tale che 
    \[
        \forall P\in\pskel{K}{0}\quad h(St(P,K))\subset St(f(P),L)    
    \]
    si dice approssimazione simpliciale di $h$
\end{definition}
\end{document}